...
local mysprite = CreateSpriteFromFile("recalltracker.png")
...
if BaseultMenu.RT:Value() then
	...
	for Champ, recall in pairs(Isrecalling) do
	  ...
	  if i>0 then FillRect(400,500+18-2,168,1,0xC0000000) end
	    if recall.info.isStart and mysprite > 0 then
	    DrawSprite(mysprite,1000,150,1,1,400,100,ARGB(255,255,255,255))
		DrawText( Champ .. " (" .. percent .. "%" .. ")", 12, (250*leftTime/recall.info.totalTime)+1050, 150, percentToRGB(percent))
	    FillRect(1089,178,250*leftTime/recall.info.totalTime,8,percentToRGB(percent))
	    else
